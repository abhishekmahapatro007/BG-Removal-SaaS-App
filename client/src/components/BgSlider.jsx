...
const BgSlider = () => {
    ...
    return (
        <div className='pb-10 md:py-20 mx-2'>
            <h1 className='mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900
            ...
            <div className='relative w-full max-w-3xl overflow-hidden m-auto rounded-xl'>
                ...
                <img src={assets.image_w_bg} 
                    style={{clipPath: `inset(0 ${100.2 - sliderPosition}% 0 0)`}} alt="" 
                />
                {/* FOREGROUND IMAGE */}
                <img className='absolute top-0 left-0 w-full h-full'
                    style={{clipPath: `inset(0 0 0 ${sliderPosition}%)`}}
                    src={assets.image_wo_bg} alt="" 
                />
