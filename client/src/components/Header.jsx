        ...
        <div className='flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:mx-44 sm:mt-20'>
            ...
            <div >
                <h1 className='text-4xl xl:text-5xl 2xl:text-6xl font-bold text-neutral-700 leading-tight'>
                    ...
                    from <br className='max-sm:hidden' />images for free.
                </h1>
                <p className='my-6 text-[15px] text-gray-500'>
                    Effortlessly remove image backgrounds with just a few clicks.
                    No technical skills required,<br />perfect for personal or professional use.
                    Get high-quality results instantly, completely free!
                </p>
                <div>
                    <input onChange={e => removeBg(e.target.files[0])} type="file"
                        accept='image/*' id='upload1' hidden/>
