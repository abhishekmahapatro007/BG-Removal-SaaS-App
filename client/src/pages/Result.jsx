    ...
    <div className='mx-4 my-3 lg:mx-44 mt-14 min-h-[75vh]'>
      ...
      <div className='bg-white rounded-lg px-8 py-6 drop-shadow-sm'>
        ...
        {resultImage && 
          ...
          <button className='px-8 py-2.5 text-violet-600 text-sm border border-violet-600 rounded-full 
          hover:scale-105 transition-all duration-700'>
            Try another image
          </button>
          <a href={resultImage} download className='px-8 py-2.5 text-white text-sm bg-gradient-to-r from-violet-600 to-fuchsia-500
